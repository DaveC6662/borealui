...
import Popover from "@/components/PopOver/core/PopOver";
...
export const PlacementVariants: Story = {
  render: () => (
    <div style={{ display: "grid", gap: "2rem", gridTemplateColumns: "repeat(2, auto)" }}>
      <Popover
...
export const KeyboardAccessible: Story = {
  args: {
    ...
    content: <div style={{ padding: "0.5rem" }}>This opens on Enter and closes on Escape.</div>,
  },
};
